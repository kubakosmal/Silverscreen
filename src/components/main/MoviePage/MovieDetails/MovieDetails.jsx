...
export default function MovieDetails(props) {
  ...
  return (
    <div className="flex flex-col my-6 border-b-2 md:border-transparent border-zinc-900">
      <div className=" flex text-sm flex-col rounded-md  border-zinc-800">
        <div className="text-gray-300 px-2 font-oxygen">
          <div className="flex flex-col my-2 border-b-2 border-zinc-900">
            <p className="font-bold text-md md:text-lg">Original title </p>
            <p className="text-secondary text-xs md:text-sm">
              {props.originalTitle}
            </p>
          </div>
          <div className="flex flex-col my-2 border-b-2 border-zinc-900">
            <p className="font-bold text-md md:text-lg">Original Language </p>
            <p className="text-secondary text-xs md:text-sm">
              {originalLanguage}
            </p>
          </div>
          ...
          <div className="flex flex-col my-2 border-b-2 border-zinc-900">
            <p className="font-bold text-md md:text-lg">Budget </p>
            <p className="text-secondary text-xs md:text-sm">{budget}</p>
          </div>
        </div>

        <div className="text-gray-300 px-2 rounded-md">
          <div className="flex flex-col border-b-2 border-zinc-900 ">
            <p className="font-bold text-md md:text-lg">Release Date </p>
            <p className="text-secondary text-xs md:text-sm">
              {props.releaseDate}
            </p>
          </div>
          <div className="flex flex-col my-2 border-b-2 border-zinc-900">
            <p className="font-bold text-md md:text-lg">Genre </p>
            <div className="flex text-secondary text-xs md:text-sm">
          ...
          <div className="flex flex-col my-2 border-b-2 border-zinc-900">
            ...
            <p className="text-secondary text-xs md:text-sm">{revenue}</p>
          </div>
        </div>
      </div>
    </div>
